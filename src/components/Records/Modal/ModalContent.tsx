            ...
            <div className="py-3 d-flex flex-column justify-content-center align-items-center w-80 px-3 gap-3">
                <div className="w-100 d-flex gap-2">
                    <div className="input-group">
                        ...
                        <input
                            type="text"
                            placeholder="Кліент(пошук за номером телефону)"
                                ...
                                {clients &&
                                    clients.map((client, index) => {
                                        return (
                                            <div
                                                key={index}
                                                className="client-item p-2 d-flex align-items-center justify-content-around"
                                                onClick={() =>
                ...
                <div className="d-flex justify-content-between gap-3 w-100">
                    <input
                        ...
                        required
                        value={markModel}
                        onChange={(e) => setMarkModel(e.target.value)}
                    />
                    <input
                        type="text"
                        className="form-control"
